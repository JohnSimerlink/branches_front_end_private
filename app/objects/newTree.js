...
export async function newTree(type, parentTreeId,primaryParentTreeContentURI, values){
    ...
    var tree = new Tree({contentId: newContent.id, parentId: parentTreeId,  x: newChildTreeX, y: newChildTreeY, createInDB: true, level: parentTree.treeDataFromDB.level + 1})
