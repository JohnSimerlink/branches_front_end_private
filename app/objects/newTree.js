...
export async function newTree(type, parentTreeId,primaryParentTreeContentURI, values){
    ...
    var tree = new Tree({contentId: newContent.id, parentId: parentTreeId, parentDegree: parentTreeUINode.degree + 1, x: newChildTreeX, y: newChildTreeY, createInDB: true})
