...
export const TYPES = {
	...
	fImportSigmaConstructor: Symbol('fImportSigmaConstructor'),
	...
	IKnowledgeMapCreator: Symbol('IKnowledgeMapCreator'),
	...
	ITooltipConfigurer: Symbol('ITooltipConfigurer'),
	ITooltipRendererFunction: Symbol('ITooltipRendererFunction'),
	ITree: Symbol('ITree'),
	ICardMainCreator: Symbol('ICardMainCreator'),
	...
	IVueComponentCreator: Symbol('IVueComponentCreator'),
	IUserLoader: Symbol('IUserLoader'),
	IUserUtils: Symbol('IUserUtils'),
	IVuexStore: Symbol('IVuexStore'),
	KnowledgeMapCreatorArgs: Symbol('KnowledgeMapCreatorArgs'),
	ManagedSigmaNodeCreatorCoreArgs: Symbol('ManagedSigmaNodeCreatorCoreArgs'),
	MainMenuCreatorArgs: Symbol('MainMenuCreatorArgs'),
	MapStateManagerArgs: Symbol('MapStateManagerArgs'),
	...
	NodeHoverIconsCreatorArgs: Symbol('NodeHoverIconsCreatorArgs'),
	...
	CardMainCreatorArgs: Symbol('CardMainCreatorArgs'),
	Sigma: Symbol('Sigma'),
