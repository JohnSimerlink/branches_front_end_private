...
// TODO; Separate enums into their own files in one interfaces folder, and perhaps have interfaces file compose
//  them, or just keep in separate files
export type ISigmaEvent = {}
