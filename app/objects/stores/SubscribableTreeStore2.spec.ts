...
import {
    ...
    ISubscribableStore, ISubscribableTreeCore, TreePropertyNames} from '../interfaces';
...
describe('SubscribableTreeStore > addAndSubscribeToItem', () => {
    it('An update in a member tree should be published to a subscriber of the tree data stores', () => {
        ...
        const treeStore: ISubscribableStore<ISubscribableTreeCore> = new SubscribableStore<ISubscribableTreeCore>({
            store: {},
            updatesCallbacks: []
        })
