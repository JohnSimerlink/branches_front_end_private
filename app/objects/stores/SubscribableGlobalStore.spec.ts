...
import {GlobalDataStoreObjectDataTypes} from '../interfaces';
...
test('ISubscribableGlobalStore::::After calling startPublishing, globalStore should publish updates'
    ...
    expect(callback1.getCall(0).args[0].type).to.deep.equal(GlobalDataStoreObjectDataTypes.TREE_DATA)
    ...
    expect(callback2.getCall(0).args[0].type).to.deep.equal(GlobalDataStoreObjectDataTypes.TREE_DATA)
    t.pass()
})
...
test('ISubscribableGlobalStore::::After calling startPublishing, globalStore should publish updates'
    ...
    expect(callback1.getCall(0).args[0].type).to.deep.equal(GlobalDataStoreObjectDataTypes.CONTENT_USER_DATA)
    expect(callback2.callCount).to.equal(1)
    ...
    expect(callback2.getCall(0).args[0].type).to.deep.equal(GlobalDataStoreObjectDataTypes.CONTENT_USER_DATA)
    t.pass()
})
