...
export const sampleContentUser1Id = getContentUserId({userId: sampleContentUser1UserId, contentId: sampleContentUser1ContentId});
...
export function getASampleContentUser({contentId}) {
    ...
    const nextReviewTimeVal =
        calculateNextReviewTime({lastInteractionTime: lastInteractionTimeVal,
