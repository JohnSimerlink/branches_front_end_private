...
import {sampleTree1Children, sampleTree1ContentId, sampleTree1ParentId, sampleTreeData1} from './treeTestHelpers';
...
test('SubscribableTree:::.val() should display the value of the tree', (t) => {
	...
	const tree = new SubscribableTree({
		updatesCallbacks: [], id: TREE_ID, contentId: sampleTree1ContentId,
		parentId: sampleTree1ParentId, children: sampleTree1Children
	});
