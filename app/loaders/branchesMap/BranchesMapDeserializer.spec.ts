...
test('BranchesMapDeserializer::: deserialize should deserialize properly', (t) => {
    ...
    const deserializedBranchesMap: IMutableSubscribableBranchesMap = BranchesMapDeserializer.deserialize({userData})
...
test('BranchesMapDeserializer::: deserializeFromDB Should deserializeFromDB properly', (t) => {
    ...
    const userDataFromDB: IBranchesMapDataFromDB = {
    ...
    const deserializedBranchesMap: IMutableSubscribableBranchesMap = BranchesMapDeserializer.deserializeFromDB({userDataFromDB})
    expect(deserializedBranchesMap).to.deep.equal(expectedBranchesMap)
    t.pass()
})
