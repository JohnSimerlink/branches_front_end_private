/**
 * Manually added by John 03/22/2018 so that we could import the interfaces without importing the entire library . . .
 * because importing the entire library takes 400 ms on my machine
 * which can take a lot of time when runnind 100 different unit test files that each import the entire
 * library just when I'm trying to get the type definitions and not
