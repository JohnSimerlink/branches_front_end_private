  ...
  function glyphs (params) {
    ...
    function draw (o, context) {
      ...
      if (o.draw && o.x && o.y && o.radius > o.threshold) {
        ...
        switch (o.position) {
          case 'top-right':
            x += 2 * o.nodeSize * cos315;
            y += 2 * o.nodeSize * sin315;
            break;
          case 'top-left':
            x += 2 * o.nodeSize * cos225;
            y += 2 * o.nodeSize * sin225;
            break;
          case 'bottom-left':
            x += 2 * o.nodeSize * cos135;
            y += 2 * o.nodeSize * sin135;
            break;
          case 'bottom-right':
            x += 2 * o.nodeSize * cos45;
            y += 2 * o.nodeSize * sin45;
            break;
        }
        // Glyph rendering
