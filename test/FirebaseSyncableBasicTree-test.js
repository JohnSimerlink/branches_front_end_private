...
describe('FirebaseSyncableBasicTree', function () {
    it('constructor should have firebase syncers subscribe to all the subscribable properties', function () {
        ...
        var parentId = inversify_config_1.myContainer.get(types_1.TYPES.ISubscribableMutableId);
        var children = inversify_config_1.myContainer.get(types_1.TYPES.ISubscribableMutableStringSet);
        var TREE_ID = 'efa123';
