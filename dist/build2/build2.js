...
(function (root, factory) {
     ...
     */
    var Taggle = function Taggle(el, options) {
    ...
    Taggle.prototype._formatTag = function (text) {
        var MAX_DISPLAY_LENGTH = 30; //TODO make this more dynamic for different sized mobile devices . . . or use a diff solution
        if (text.length > MAX_DISPLAY_LENGTH) {
            text = ". . . " + text.substring(text.length - (MAX_DISPLAY_LENGTH - 5), text.length);
        }
